    ...
    return (
        <div className='my-10'>
            <div className='text-center '>
                <h1 className=' text-[#00307E] font-extrabold text-5xl mb-10 inline-block relative my-underline'>Add Books</h1>
            </div>
            ...
            <div className='my-10 md:w-1/2 m-auto'>
                ...
                <form onSubmit={handelAddBook} autoComplete='off' className='shadow-md p-10' >
                    ...
                    <div className="relative z-0 w-full mb-6 group">
                        ...
                        <label htmlFor="floating_repeat_password" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Book's Name</label>
                    </div>
