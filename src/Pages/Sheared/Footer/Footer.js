...
const Footer = () => {
    return (
        <footer className="p-4 bg-[#00307e] sm:p-6 dark:bg-gray-800">
            <div className="md:flex md:justify-around md:px-20">
                <div className="mb-6 md:mb-0">

                    <Link to='/'>
                        <span className="self-center text-2xl mt-12 inline-block font-semibold whitespace-nowrap text-white">
                            Book Hut
                        </span>
                    </Link>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 className="mb-6 text-sm font-bold text-white underline uppercase dark:text-white">Resources</h2>
                        <ul className="text-white dark:text-gray-400">
                            <li className="mb-4">
                                <Link to="/add-items" className="hover:underline">Add Items</Link>
                            </li>
                            <li>
                                <Link to="/manage-items" className="hover:underline">All Books</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-white underline">Follow us</h2>
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-white underline uppercase dark:text-white">Legal</h2>
                        <ul className="text-white ">
                            <li className="mb-4">
            ...
            <div className="sm:flex sm:items-center sm:justify-around text-center">
                ...
                <div className="flex mt-4 space-x-6 justify-center sm:mt-0">
                    <Link to="#" className="text-white hover:text-orange-500 dark:hover:text-white">
